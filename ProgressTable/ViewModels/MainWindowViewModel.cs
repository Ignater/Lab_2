...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Panchenko Alan Yurievich", Visual=0, Architecture=0, Networks=0, Calculate_Math=0, PI=0, Math=0, Electric=0},
                new Student{Name="Trifonov Ignat Aleksandrovich", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
